...
AGB.sp22.data.subset$ID[AGB.sp22.data.subset$ID %in% c("Xylopia quintesi")] <- "	
Xylopia quintasii"
...
AGB.sp22.data.subset$ID[AGB.sp22.data.subset$ID %in% c("Salacia sp 1A")] <- "Salacia sp 1"
...
unique(AGB.sp22.data.subset$Spp.match)

...
#column names 
colnames(AGB.sp22.data.subset) = c("Data_Collection_Season", "Date", "Proj.Plot", "Grid", "Plant_tag", "X_Coord", "Y_Coord", "Tool", "POM", "DBH_mm", "Height_m", "Veg_Type", "Notes", "ID")
...
AGB.sp22.data.subset <- AGB.sp22.data.subset %>%
  select(Data_Collection_Season:ID)

write.csv(AGB.sp22.data.subset, file = "Cleaner_Data_for_Camille.csv")

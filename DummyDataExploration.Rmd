...
cor(summary_stats$Distance, summary_stats$Shannon_Diversity)
cor(summary_stats$Distance, summary_stats$agb)
cor(summary_stats$Distance, summary_stats$Genus_Richness)
...
ggarrange(agb_plot, diversity_plot, labels=c("a", "b"), nrow=2)
